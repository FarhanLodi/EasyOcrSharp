...
/// <summary>
/// Which ONNX Runtime execution provider EasyOcrSharp.Structure.Engine should try to use. Every non-CPU provider
/// needs the matching native runtime package installed; if it is missing or initialization fails,
/// EasyOcrSharp.Structure.Engine logs a warning and falls back to CPU rather than throwing.
/// </summary>
internal enum OcrExecutionProvider
{
    /// <summary>
    ...
    /// <summary>
    /// NVIDIA CUDA. Requires the <c>EasyOcrSharp.Gpu</c> package and CUDA 12+ on PATH.
    /// </summary>
    Cuda = 1,
